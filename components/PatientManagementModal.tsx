                    ...
                    {editingPatient ? (
                        <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                            <div className="space-y-1">
                                <label className="text-[10px] font-bold text-amber-500 uppercase tracking-widest">患者姓名</label>
                                <input
                                    type="text"
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <span className="text-sm font-bold text-amber-500 group-hover:text-emerald-400">新增患者資料</span>
                            </button>
                                ...
                                <label className="flex items-center justify-between cursor-pointer group">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-[10px] text-amber-500">選擇患者後自動撈取歷史紀錄並生成建議</div>
                                        </div>
                                    </div>
                                    <div
